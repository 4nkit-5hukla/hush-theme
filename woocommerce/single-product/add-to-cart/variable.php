			...
			<tbody>
				<?php foreach ( $attributes as $name => $options ) : ?>
					...
					<tr class="attribute-<?php echo esc_attr( $sanitized_name ); ?>">
						...
						?>
						<td class="value btn-group btn-group-toggle mt-2 variant-btn w-100 product-price-variant">
							<?php
							if ( ! empty( $options ) ) {
							...
							echo end( $attribute_keys ) === $name ? wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" style="text-decoration:none; color:#000;" href="#">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) ) : '';
							?>
						</td>
					</tr>
				<?php endforeach; ?>
